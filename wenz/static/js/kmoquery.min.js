(function(e, t) {
    ...
    d.extend({
        ...
        type: function(e) {
            ...
            return typeof e === "object" || typeof e === "function" ? o[l.call(e)] || "object" : typeof e
        },
    ...
    var y = function(e) {
        var t, n, i, r, a, s, o, l, u, f, c, d, h, p, g, m, v, y, b, w = "sizzle" + 1 * new Date,
            x = e.document,
            C = 0,
            S = 0,
            T = oe(),
        ...
        function se(e, t, i, r) {
            ...
            i = i || [];
            f = t.nodeType;
            if (typeof e !== "string" || !e || f !== 1 && f !== 9 && f !== 11) {
                return i
            }
            if (!r && g) {
                if (f !== 11 && (a = Z.exec(e))) {
                    if (u = a[1]) {
                        if (f === 9) {
                            ...
                            if (t.ownerDocument && (o = t.ownerDocument.getElementById(u)) && b(t, o) && o.id === u) {
                                i.push(o);
                                return i
                            }
                        }
                        ...
                        return i
                    } else if ((u = a[3]) && n.getElementsByClassName) {
                        O.apply(i, t.getElementsByClassName(u));
                        return i
                    }
                }
                if (n.qsa && (!m || !m.test(e))) {
                    ...
                    if (S) {
                        try {
                            O.apply(i, C.querySelectorAll(S));
                            return i
                        } catch (T) {} finally {
                            if (!v) {
        ...
        function ce(e, t) {
            var n = t && e,
                i = n && e.nodeType === 1 && t.nodeType === 1 && (~t.sourceIndex || F) - (~e.sourceIndex || F);
            if (i) {
                return i
            }
            if (n) {
        ...
        d = se.setDocument = function(e) {
            ...
            if (s === h || s.nodeType !== 9 || !s.documentElement) {
                return h
            }
            h = s;
            p = s.documentElement;
            ...
            n.getElementsByClassName = J.test(s.getElementsByClassName);
            ...
            v = [];
            m = [];
            if (n.qsa = J.test(s.querySelectorAll)) {
                ue(function(e) {
            ...
            if (n.matchesSelector = J.test(y = p.matches || p.webkitMatchesSelector || p.mozMatchesSelector || p.oMatchesSelector || p.msMatchesSelector)) {
                ue(function(e) {
            ...
            A = t ? function(e, t) {
                ...
                var n, i = 0,
                    ...
                    l = [t];
                if (!r || !a) {
                    return e === s ? -1 : t === s ? 1 : r ? -1 : a ? 1 : f ? _(f, e) - _(f, t) : 0
                } else if (r === a) {
                    return ce(e, t)
                }
                n = e;
                ...
                return i ? ce(o[i], l[i]) : o[i] === x ? -1 : l[i] === x ? 1 : 0
            };
            return s
        };
        ...
        se.matchesSelector = function(e, t) {
            ...
            t = t.replace(U, "='$1']");
            if (n.matchesSelector && g && (!v || !v.test(t)) && (!m || !m.test(t))) {
                try {
                    var i = y.call(e, t);
        ...
        se.attr = function(e, t) {
            ...
            var r = i.attrHandle[t.toLowerCase()],
                a = r && $.call(i.attrHandle, t.toLowerCase()) ? r(e, t, !g) : undefined;
            return a !== undefined ? a : n.attributes || !g ? e.getAttribute(t) : (a = e.getAttributeNode(t)) && a.specified ? a.value : null
        };
        se.error = function(e) {
        ...
        i = se.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    ...
                    if (e[3]) {
                        e[2] = e[4] || e[5] || ""
                    } else if (n && G.test(n) && (t = s(n, true)) && (t = n.indexOf(")", n.length - t) - n.length)) {
                        e[0] = e[0].slice(0, t);
                        e[2] = n.slice(0, t)
                    }
                    return e.slice(0, 3)
            ...
            filter: {
                ...
                ATTR: function(e, t, n) {
                    return function(i) {
                        ...
                        r += "";
                        return t === "=" ? r === n : t === "!=" ? r !== n : t === "^=" ? n && r.indexOf(n) === 0 : t === "*=" ? n && r.indexOf(n) > -1 : t === "$=" ? n && r.slice(-n.length) === n : t === "~=" ? (" " + r.replace(P, " ") + " ").indexOf(n) > -1 : t === "|=" ? r === n || r.slice(0, n.length + 1) === n + "-" : false
                    }
                },
                CHILD: function(e, t, n, i, r) {
                    ...
                    return i === 1 && r === 0 ? function(e) {
                        ...
                        var u, f, c, d, h, p, g = a !== s ? "nextSibling" : "previousSibling",
                            m = t.parentNode,
                        ...
                        if (m) {
                            if (a) {
                                while (g) {
                                    c = t;
                                    while (c = c[g]) {
                                        if (o ? c.nodeName.toLowerCase() === v : c.nodeType === 1) {
                                            return false
                                        }
                                    }
                            ...
                            if (s && y) {
                                ...
                                while (c = ++h && c && c[g] || (d = h = 0) || p.pop()) {
                                    if ((o ? c.nodeName.toLowerCase() === v : c.nodeType === 1) && ++d) {
                                        if (y) {
                                            (c[w] || (c[w] = {}))[e] = [C, d]
                                        }
                                        if (c === t) {
        ...
        function Ce(e, t, n, i, r, a) {
            ...
            return le(function(a, s, o, l) {
                var u, f, c, d = [],
                    h = [],
                    p = s.length,
                    g = a || we(t || "*", o.nodeType ? [o] : o, []),
                    m = e && (a || !t) ? xe(g, d, e, o, l) : g,
                    v = n ? r || (a ? e : p || i) ? [] : s : m;
                if (n) {
                    n(m, v, o, l)
                }
        ...
        function Se(e) {
            var t, n, r, a = e.length,
                ...
                d = [function(e, n, i) {
                    var r = !s && (i || n !== u) || ((t = n).nodeType ? f(e, n, i) : c(e, n, i));
                    t = null;
                    return r
                }];
            for (; l < a; l++) {
                if (n = i.relative[e[l].type]) {
                    ...
                    if (n[w]) {
                        ...
                        return Ce(l > 1 && be(d), l > 1 && ve(e.slice(0, l - 1).concat({
                            value: e[l - 2].type === " " ? "*" : ""
                        })).replace(z, "$1"), n, l < r && Se(e.slice(l, r)), r < a && Se(e = e.slice(r)), r < a && ve(e))
                    }
                    d.push(n)
                }
            }
            ...
            var n = t.length > 0,
                ...
                a = function(a, s, o, l, f) {
                    var c, d, p, g = 0,
                        ...
                        b = u,
                        w = a || r && i.find["TAG"]("*", f),
                        x = C += b == null ? 1 : Math.random() || .1,
                        S = w.length;
                    if (f) {
                        u = s !== h && s
                    }
                    for (; m !== S && (c = w[m]) != null; m++) {
                        if (r && c) {
                            d = 0;
                            while (p = e[d++]) {
                                if (p(c, s, o)) {
                    ...
                    if (n && m !== g) {
                        ...
                        O.apply(l, y);
                        if (f && !a && y.length > 0 && g + t.length > 1) {
                            se.uniqueSort(l)
                        }
                    }
                    if (f) {
        ...
        l = se.select = function(e, t, r, a) {
            var l, u, f, c, d, h = typeof e === "function" && e,
                p = !a && s(e = h.selector || e);
            r = r || [];
            if (p.length === 1) {
                u = p[0] = p[0].slice(0);
                if (u.length > 2 && (f = u[0]).type === "ID" && n.getById && t.nodeType === 9 && g && i.relative[u[1].type]) {
                ...
                l = Q["needsContext"].test(e) ? 0 : u.length;
                while (l--) {
                    f = u[l];
                    ...
                    if (d = i.find[c]) {
                        if (a = d(f.matches[0].replace(ne, ie), ee.test(u[0].type) && ge(t.parentNode) || t)) {
                            u.splice(l, 1);
                            e = a.length && ve(u);
                            if (!e) {
                                O.apply(r, a);
            ...
            }(h || o(e, p))(a, t, !g, r, ee.test(e) && ge(t.parentNode) || t);
            return r
        };
            ...
            if (typeof e === "string") {
                ...
                if (n && (n[1] || !t)) {
                    if (n[1]) {
                        ...
                        d.merge(this, d.parseHTML(n[1], t && t.nodeType ? t.ownerDocument || t : T, true));
                        if (w.test(n[1]) && d.isPlainObject(t)) {
                            for (n in t) {
                ...
                return typeof S.ready !== "undefined" ? S.ready(e) : e(d)
            }
    ...
    d.fn.extend({
        ...
        closest: function(e, t) {
            var n, i = 0,
                r = this.length,
                a = [],
                s = b.test(e) || typeof e !== "string" ? d(e, t || this.context) : 0;
            for (; i < r; i++) {
    ...
    d.Callbacks = function(e) {
        e = typeof e === "string" ? N[e] || D(e) : d.extend({}, e);
        var t, n, i, r, a, s, o = [],
            l = !e.once && [],
            u = function(c) {
                n = e.memory && c;
                ...
                t = true;
                for (; o && a < r; a++) {
                    if (o[a].apply(c[0], c[1]) === false && e.stopOnFalse) {
                        n = false;
                        break
                    }
                }
            ...
            f = {
                ...
                has: function(e) {
                    return e ? d.inArray(e, o) > -1 : !!(o && o.length)
                },
                empty: function() {
                    o = [];
                    r = 0;
    ...
    d.extend({
                            ...
                            d.each(t, function(t, a) {
                                ...
                                r[a[1]](function() {
                                    ...
                                    if (e && d.isFunction(e.promise)) {
                                        ...
                                        n[a[0] + "With"](this === i ? n.promise() : this, s ? [e] : arguments)
                                    }
                                })
                            });
                            e = null
        ...
        when: function(e) {
            var t = 0,
                n = i.call(arguments),
                r = n.length,
                a = r !== 1 || e && d.isFunction(e.promise) ? r : 0,
                s = a === 1 ? e : d.Deferred(),
                o = function(e, t, n) {
                    return function(r) {
                        t[e] = this;
            ...
            if (r > 1) {
                ...
                for (; t < r; t++) {
                    if (n[t] && d.isFunction(n[t].promise)) {
                        n[t].promise().done(o(t, f, n)).fail(s.reject).progress(o(t, u, l))
                    } else {
                        --a
                    }
                }
    ...
    function I() {
        if (T.addEventListener) {
            T.removeEventListener("DOMContentLoaded", _, false);
            e.removeEventListener("load", _, false)
        } else {
            T.detachEvent("onreadystatechange", _);
    ...
    d.ready.promise = function(t) {
        if (!O) {
            ...
            if (T.readyState === "complete") {
                ...
                T.addEventListener("DOMContentLoaded", _, false);
    ...
    function M(e, t, n) {
        if (n === undefined && e.nodeType === 1) {
            ...
            if (typeof n === "string") {
                try {
                    n = n === "true" ? true : n === "false" ? false : n === "null" ? null : +n + "" === n ? +n : j.test(n) ? d.parseJSON(n) : n
                } catch (r) {}
                d.data(e, t, n)
            } else {
                n = undefined
    ...
    d.fn.extend({
        data: function(e, t) {
            ...
            if (e === undefined) {
                if (this.length) {
                    r = d.data(a);
                    if (a.nodeType === 1 && !d._data(a, "parsedAttrs")) {
                        n = s.length;
                        while (n--) {
                            if (s[n]) {
                                i = s[n].name;
    ...
    var G = d.access = function(e, t, n, i, r, a, s) {
        var o = 0,
            l = e.length,
            u = n == null;
        if (d.type(n) === "object") {
    ...
    (function() {
        ...
        f.html5Clone = T.createElement("nav").cloneNode(true).outerHTML !== "<:nav></:nav>";
        e.type = "checkbox";
        e.checked = true;
        n.appendChild(e);
    ...
    d.event = {
        ...
        add: function(e, t, n, i, r) {
            var a, s, o, l, u, f, c, h, p, g, m, v = d._data(e);
            if (!v) {
                return
            }
            if (n.handler) {
            ...
            if (!(f = v.handle)) {
                f = v.handle = function(e) {
                    return typeof d !== H && (!e || d.event.triggered !== e.type) ? d.event.dispatch.apply(f.elem, arguments) : undefined
                };
                f.elem = e
            }
            t = (t || "").match(L) || [""];
            ...
            while (o--) {
                ...
                if (!(h = s[p])) {
                    h = s[p] = [];
                    h.delegateCount = 0;
                    if (!u.setup || u.setup.call(e, i, g, f) === false) {
                ...
                d.event.global[p] = true
            }
            e = null
        },
        remove: function(e, t, n, i, r) {
            var a, s, o, l, u, f, c, h, p, g, m, v = d.hasData(e) && d._data(e);
            if (!v || !(f = v.events)) {
                return
            }
            t = (t || "").match(L) || [""];
            ...
            while (u--) {
                ...
                if (!p) {
                    for (p in f) {
                        d.event.remove(e, p + t[u], n, i, true)
                    }
                    continue
                }
                c = d.event.special[p] || {};
                ...
                h = f[p] || [];
                o = o[2] && new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)");
                l = a = h.length;
                while (a--) {
                    s = h[a];
                    if ((r || m === s.origType) && (!n || n.guid === s.guid) && (!o || o.test(s.namespace)) && (!i || i === s.selector || i === "**" && s.selector)) {
                        h.splice(a, 1);
                        if (s.selector) {
                            h.delegateCount--
                        }
                ...
                if (l && !h.length) {
                    if (!c.teardown || c.teardown.call(e, g, v.handle) === false) {
        ...
        trigger: function(t, n, i, r) {
            ...
            s = g.indexOf(":") < 0 && "on" + g;
            t = t[d.expando] ? t : new d.Event(g, typeof t === "object" && t);
            t.isTrigger = r ? 2 : 3;
            t.namespace = m.join(".");
            ...
            if (!r && !f.noBubble && !d.isWindow(i)) {
                ...
                if (c === (i.ownerDocument || T)) {
                    p.push(c.defaultView || c.parentWindow || e)
                }
            }
            h = 0;
            while ((o = p[h++]) && !t.isPropagationStopped()) {
                t.type = h > 1 ? l : f.bindType || g;
                a = (d._data(o, "events") || {})[t.type] && d._data(o, "handle");
                if (a) {
                    a.apply(o, n)
                }
                a = s && o[s];
                if (a && a.apply && d.acceptData(o)) {
            ...
            if (!r && !t.isDefaultPrevented()) {
                if ((!f._default || f._default.apply(p.pop(), n) === false) && d.acceptData(i)) {
                    if (s && i[g] && !d.isWindow(i)) {
                        c = i[s];
                        if (c) {
                            i[s] = null
                        }
        ...
        dispatch: function(e) {
            ...
            o = d.event.handlers.call(this, e, u);
            t = 0;
            while ((a = o[t++]) && !e.isPropagationStopped()) {
                ...
                while ((r = a.handlers[s++]) && !e.isImmediatePropagationStopped()) {
                    if (!e.namespace_re || e.namespace_re.test(r.namespace)) {
                        e.handleObj = r;
                        e.data = r.data;
                        n = ((d.event.special[r.origType] || {}).handle || r.handler).apply(a.elem, l);
                        if (n !== undefined) {
                            if ((e.result = n) === false) {
                                e.preventDefault();
                                e.stopPropagation()
        ...
        handlers: function(e, t) {
            var n, i, r, a, s = [],
                o = t.delegateCount,
                l = e.target;
            if (o && l.nodeType && (!e.button || e.type !== "click")) {
        ...
        fix: function(e) {
            ...
            var t, n, i, r = e.type,
                ...
                s = this.fixHooks[r];
            if (!s) {
                this.fixHooks[r] = s = Y.test(r) ? this.mouseHooks : K.test(r) ? this.keyHooks : {}
            }
    ...
    d.removeEvent = T.removeEventListener ? function(e, t, n) {
    ...
    d.Event = function(e, t) {
        ...
        if (e && e.type) {
            ...
            this.type = e.type;
            this.isDefaultPrevented = e.defaultPrevented || e.defaultPrevented === undefined && e.returnValue === false ? ee : te
        } else {
            this.type = e
        }
        if (t) {
        ...
        d.event.special.submit = {
            setup: function() {
                ...
                d.event.add(this, "click._submit keypress._submit", function(e) {
                    var t = e.target,
                        n = d.nodeName(t, "input") || d.nodeName(t, "button") ? t.form : undefined;
        ...
        d.event.special.change = {
            setup: function() {
                ...
                d.event.add(this, "beforeactivate._change", function(e) {
                    var t = e.target;
                    if (Q.test(t.nodeName) && !d._data(t, "changeBubbles")) {
    ...
    var re = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|" + "header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
        ...
        ye = ie(T),
        be = ye.appendChild(T.createElement("div"));
    ...
    function we(e, t) {
        var n, i, r = 0,
            a = typeof e.getElementsByTagName !== H ? e.getElementsByTagName(t || "*") : typeof e.querySelectorAll !== H ? e.querySelectorAll(t || "*") : undefined;
        if (!a) {
            for (a = [], n = e.childNodes || e;
                (i = n[r]) != null; r++) {
                if (!t || d.nodeName(i, t)) {
                    a.push(i)
                } else {
        ...
        return t === undefined || t && d.nodeName(e, t) ? d.merge([e], a) : a
    }
    ...
    d.extend({
        clone: function(e, t, n) {
            var i, r, a, s, o, l = d.contains(e.ownerDocument, e);
            if (f.html5Clone || d.isXMLDoc(e) || !se.test("<" + e.nodeName + ">")) {
                a = e.cloneNode(true)
            } else {
                be.innerHTML = e.outerHTML;
                be.removeChild(a = be.firstChild)
            }
            ...
            for (; m < h; m++) {
                ...
                if (a || a === 0) {
                    if (d.type(a) === "object") {
                        ...
                        c = ve[l] || ve._default;
                        o.innerHTML = c[1] + a.replace(le, "<$1></$2>") + c[2];
                        r = c[0];
                        while (r--) {
                            o = o.lastChild
                        }
                        if (!f.leadingWhitespace && oe.test(a)) {
                            g.push(t.createTextNode(oe.exec(a)[0]))
                        }
                        if (!f.tbody) {
                            a = l === "table" && !fe.test(a) ? o.firstChild : c[1] === "<table>" && !fe.test(a) ? o : 0;
                            r = a && a.childNodes.length;
                            while (r--) {
                                if (d.nodeName(u = a.childNodes[r], "tbody") && !u.childNodes.length) {
                                    a.removeChild(u)
                                }
                            }
                        }
                        d.merge(g, o.childNodes);
                        o.textContent = "";
                        while (o.firstChild) {
                ...
                if (t || d.acceptData(i)) {
                    ...
                    if (s) {
                        ...
                        if (u[a]) {
                            ...
                            if (c) {
                                delete i[l]
                            } else if (typeof i.removeAttribute !== H) {
                                i.removeAttribute(l)
                            } else {
                                i[l] = null
                            }
    ...
    d.fn.extend({
        text: function(e) {
            return G(this, function(e) {
                return e === undefined ? d.text(this) : this.empty().append((this[0] && this[0].ownerDocument || T).createTextNode(e))
        ...
        html: function(e) {
            return G(this, function(e) {
                var t = this[0] || {},
                    ...
                    i = this.length;
                if (e === undefined) {
                    return t.nodeType === 1 ? t.innerHTML.replace(ae, "") : undefined
                }
                if (typeof e === "string" && !de.test(e) && (f.htmlSerialize || !se.test(e)) && (f.leadingWhitespace || !oe.test(e)) && !ve[(ue.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = e.replace(le, "<$1></$2>");
                    try {
                        for (; n < i; n++) {
                            t = this[n] || {};
                            if (t.nodeType === 1) {
                                d.cleanData(we(t, false));
                                t.innerHTML = e
                            }
                        }
                        t = 0
        ...
        domManip: function(e, t) {
            ...
            var n, i, a, s, o, l, u = 0,
                ...
                g = e[0],
                m = d.isFunction(g);
            if (m || c > 1 && typeof g === "string" && !f.checkClone && he.test(g)) {
            ...
            if (c) {
                ...
                if (n) {
                    ...
                    if (a) {
                        ...
                        for (u = 0; u < a; u++) {
                            i = s[u];
                            if (pe.test(i.type || "") && !d._data(i, "globalEval") && d.contains(o, i)) {
                                if (i.src) {
                                    if (d._evalUrl) {
                                        d._evalUrl(i.src)
                                    }
                                } else {
                                    d.globalEval((i.text || i.textContent || i.innerHTML || "").replace(me, ""))
                                }
                            }
                        }
                    }
    ...
    function Le(t, n) {
        var i, r = d(n.createElement(t)).appendTo(n.body),
            a = e.getDefaultComputedStyle && (i = e.getDefaultComputedStyle(r[0])) ? i.display : d.css(r[0], "display");
        r.detach();
        return a
    }
    ...
    function Ne(e) {
        ...
        if (!n) {
            n = Le(e, t);
            if (n === "none" || !n) {
                Fe = (Fe || d("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement);
                t = (Fe[0].contentWindow || Fe[0].contentDocument).document;
                t.write();
                t.close();
                n = Le(e, t);
                Fe.detach()
    ...
    var De = /^margin/;
    var Oe = new RegExp("^(" + W + ")(?!px)[a-z%]+$", "i");
    var Ie, _e, He = /^(top|right|bottom|left)$/;
    ...
    function Re(e, t) {
        ...
        function l() {
            ...
            if (e.getComputedStyle) {
                ...
                l = t.appendChild(T.createElement("div"));
                ...
                t.style.width = "1px";
                o = !parseFloat((e.getComputedStyle(l, null) || {}).marginRight);
                t.removeChild(l)
            }
        ...
        for (; s < o; s++) {
            ...
            if (t) {
                ...
                if (i.style.display === "" && U(i)) {
                    a[s] = d._data(i, "olddisplay", Ne(i.nodeName))
                }
            } else {
                r = U(i);
                if (n && n !== "none" || !r) {
    ...
    function Qe(e, t, n, i, r) {
        var a = n === (i ? "border" : "content") ? 4 : t === "width" ? 1 : 0,
            s = 0;
        for (; a < 4; a += 2) {
            if (n === "margin") {
                s += d.css(e, n + V[a], true, r)
            }
            if (i) {
                if (n === "content") {
                    s -= d.css(e, "padding" + V[a], true, r)
                }
                if (n !== "margin") {
                    s -= d.css(e, "border" + V[a] + "Width", true, r)
                }
            } else {
                s += d.css(e, "padding" + V[a], true, r);
                if (n !== "padding") {
    ...
    function Ke(e, t, n) {
        var i = true,
            ...
            a = Ie(e),
            s = f.boxSizing && d.css(e, "boxSizing", false, a) === "border-box";
        if (r <= 0 || r == null) {
            r = _e(e, t, a);
            if (r < 0 || r == null) {
                r = e.style[t]
    ...
    d.extend({
        ...
        style: function(e, t, n, i) {
            ...
            var r, a, s, o = d.camelCase(t),
                l = e.style;
            t = d.cssProps[o] || (d.cssProps[o] = Ue(l, o));
            s = d.cssHooks[t] || d.cssHooks[o];
            if (n !== undefined) {
                a = typeof n;
                if (a === "string" && (r = Pe.exec(n))) {
        ...
        css: function(e, t, n, i) {
            var r, a, s, o = d.camelCase(t);
            t = d.cssProps[o] || (d.cssProps[o] = Ue(e.style, o));
            s = d.cssHooks[t] || d.cssHooks[o];
            if (s && "get" in s) {
                a = s.get(e, true, n)
            }
            ...
            if (n === "" || n) {
                r = parseFloat(a);
                return n === true || d.isNumeric(r) ? r || 0 : a
            }
            return a
        }
    });
    d.each(["height", "width"], function(e, t) {
        d.cssHooks[t] = {
            get: function(e, n, i) {
                if (n) {
                    return Me.test(d.css(e, "display")) && e.offsetWidth === 0 ? d.swap(e, ze, function() {
                        return Ke(e, t, i)
                    }) : Ke(e, t, i)
                }
            },
            set: function(e, n, i) {
                var r = i && Ie(e);
                return Xe(e, n, i ? Qe(e, t, i, f.boxSizing && d.css(e, "boxSizing", false, r) === "border-box", r) : 0)
            }
        }
    });
    if (!f.opacity) {
        d.cssHooks.opacity = {
            ...
            set: function(e, t) {
                var n = e.style,
                    i = e.currentStyle,
                    r = d.isNumeric(t) ? "alpha(opacity=" + t * 100 + ")" : "",
                    a = i && i.filter || n.filter || "";
                n.zoom = 1;
                if ((t >= 1 || t === "") && d.trim(a.replace(je, "")) === "" && n.removeAttribute) {
                    n.removeAttribute("filter");
                    if (t === "" || i && !i.filter) {
                        return
                    }
                }
                n.filter = je.test(a) ? a.replace(je, r) : a + " " + r
            }
        }
    }
    d.cssHooks.marginRight = Re(f.reliableMarginRight, function(e, t) {
        if (t) {
            return d.swap(e, {
    ...
    d.each({
        ...
        d.cssHooks[e + t] = {
            expand: function(n) {
                ...
                for (; i < 4; i++) {
                    r[e + V[i] + t] = a[i] || a[i - 2] || a[0]
                }
                return r
            }
        };
        if (!De.test(e)) {
            d.cssHooks[e + t].set = Xe
        }
    });
    d.fn.extend({
        css: function(e, t) {
    ...
    Ye.prototype = {
        ...
        run: function(e) {
            ...
            if (n && n.set) {
                ...
                Ye.propHooks._default.set(this)
            }
            return this
        }
    };
    ...
    d.fx = Ye.prototype.init;
    d.fx.step = {};
    var Je, Ze, et = /^(?:toggle|show|hide)$/,
        tt = new RegExp("^(?:([+-])=|)(" + W + ")([a-z%]*)$", "i"),
        nt = /queueHooks$/,
        it = [lt],
        rt = {
            "*": [function(e, t) {
                var n = this.createTween(e, t),
                    ...
                    s = (d.cssNumber[e] || a !== "px" && +i) && tt.exec(d.css(n.elem, e)),
                    o = 1,
                    l = 20;
                if (s && s[3] !== a) {
                    a = a || s[3];
    ...
    function lt(e, t, n) {
        ...
        if (e.nodeType === 1 && ("height" in t || "width" in t)) {
            ...
            u = d.css(e, "display");
            c = u === "none" ? d._data(e, "olddisplay") || Ne(e.nodeName) : u;
            if (c === "inline" && d.css(e, "float") === "none") {
                if (!f.inlineBlockNeedsLayout || Ne(e.nodeName) === "inline") {
        ...
        } else if ((u === "none" ? Ne(e.nodeName) : u) === "inline") {
            g.display = u
        }
    }
    ...
    function ft(e, t, n) {
        var i, r, a = 0,
            ...
            f = u.props;
        ut(f, u.opts.specialEasing);
        for (; a < s; a++) {
            i = it[a].call(u, e, f, u.opts);
            if (i) {
                return i
            }
        }
    ...
    d.fx.start = function() {
        if (!Ze) {
            Ze = setInterval(d.fx.tick, d.fx.interval)
        }
    };
    d.fx.stop = function() {
        clearInterval(Ze);
    ...
    (function() {
        ...
        r = n.appendChild(T.createElement("option"));
        ...
        f.enctype = !!T.createElement("form").enctype;
        n.disabled = true;
        ...
        val: function(e) {
            ...
            if (!arguments.length) {
                if (r) {
                    ...
                    n = r.value;
                    return typeof n === "string" ? n.replace(ct, "") : n == null ? "" : n
                }
                return
            }
            i = d.isFunction(e);
        ...
        valHooks: {
            ...
            select: {
                ...
                set: function(e, t) {
                    ...
                    while (s--) {
                        i = r[s];
                        if (d.inArray(d.valHooks.option.get(i), a) >= 0) {
                            try {
                                i.selected = n = true
                            } catch (o) {
                                i.scrollHeight
    ...
    var dt, ht, pt = d.expr.attrHandle,
        gt = /^(?:checked|selected)$/i,
        mt = f.getSetAttribute,
        vt = f.input;
    d.fn.extend({
        attr: function(e, t) {
    ...
    d.extend({
        attr: function(e, t, n) {
            ...
            if (typeof e.getAttribute === H) {
                return d.prop(e, t, n)
            }
            if (a !== 1 || !d.isXMLDoc(e)) {
                t = t.toLowerCase();
                i = d.attrHooks[t] || (d.expr.match.bool.test(t) ? ht : dt)
            }
            if (n !== undefined) {
                if (n === null) {
                    d.removeAttr(e, t)
    ...
    ht = {
        set: function(e, t, n) {
            if (t === false) {
                d.removeAttr(e, n)
            } else if (vt && mt || !gt.test(n)) {
                e.setAttribute(!mt && d.propFix[n] || n, n)
            } else {
    ...
    d.each(d.expr.match.bool.source.match(/\w+/g), function(e, t) {
        ...
        pt[t] = vt && mt || !gt.test(t) ? function(e, t, i) {
            var r, a;
            if (!i) {
                a = pt[t];
                pt[t] = r;
    ...
    d.fn.extend({
        addClass: function(e) {
            ...
            if (u) {
                ...
                for (; o < l; o++) {
                    n = this[o];
                    i = n.nodeType === 1 && (n.className ? (" " + n.className + " ").replace(wt, " ") : " ");
                    if (i) {
                        a = 0;
                        while (r = t[a++]) {
                            if (i.indexOf(" " + r + " ") < 0) {
    ...
    d.parseJSON = function(t) {
        ...
        var n, i = null,
            r = d.trim(t + "");
        return r && !d.trim(r.replace(St, function(e, t, r, a) {
            if (n && t) {
                i = 0
            }
            if (i === 0) {
    ...
    try {
        ...
        Et = T.createElement("a");
        Et.href = "";
        Et = Et.href
    }
    Tt = Dt.exec(Et.toLowerCase()) || [];
    ...
    d.extend({
        ...
        ajax: function(e, t) {
            ...
            t = t || {};
            var n, i, r, a, s, o, l, u, f = d.ajaxSetup({}, t),
                c = f.context || f,
                h = f.context && (c.nodeType || c.jquery) ? d(c) : d.event,
                p = d.Deferred(),
            ...
            x.success = x.done;
            x.error = x.fail;
            f.url = ((e || f.url || Et) + "").replace(kt, "").replace(Nt, Tt[1] + "//");
            f.type = t.method || t.type || f.method || f.type;
            f.dataTypes = d.trim(f.dataType || "*").toLowerCase().match(L) || [""];
            if (f.crossDomain == null) {
                n = Dt.exec(f.url.toLowerCase());
                f.crossDomain = !!(n && (n[1] !== Tt[1] || n[2] !== Tt[2] || (n[3] || (n[1] === "http:" ? "80" : "443")) !== (Tt[3] || (Tt[1] === "http:" ? "80" : "443"))))
            }
            ...
            if (!f.hasContent) {
                if (f.data) {
                    r = f.url += (Ct.test(r) ? "&" : "?") + f.data;
                    delete f.data
                }
                if (f.cache === false) {
                    f.url = At.test(r) ? r.replace(At, "$1_=" + xt++) : r + (Ct.test(r) ? "&" : "?") + "_=" + xt++
                }
            }
            if (f.ifModified) {
                if (d.lastModified[r]) {
                    x.setRequestHeader("If-Modified-Since", d.lastModified[r])
                }
                if (d.etag[r]) {
            ...
            x.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + (f.dataTypes[0] !== "*" ? ", " + _t + "; q=0.01" : "") : f.accepts["*"]);
            for (i in f.headers) {
                x.setRequestHeader(i, f.headers[i])
            }
            if (f.beforeSend && (f.beforeSend.call(c, x, f) === false || b === 2)) {
                return x.abort()
            }
            w = "abort";
            for (i in {
            ...
            function S(e, t, n, i) {
                ...
                x.statusText = (t || S) + "";
                if (u) {
                    p.resolveWith(c, [v, S, x])
                } else {
                    p.rejectWith(c, [x, S, y])
                }
                x.statusCode(m);
                m = undefined;
                if (o) {
                    h.trigger(u ? "ajaxSuccess" : "ajaxError", [x, f, u ? v : y])
                }
                g.fireWith(c, [x, S]);
                if (o) {
    ...
    d.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !d(this).is(":disabled") && Ut.test(this.nodeName) && !Vt.test(e) && (this.checked || !X.test(e))
            }).map(function(e, t) {
                var n = d(this).val();
    ...
    d.ajaxSettings.xhr = e.ActiveXObject !== undefined ? function() {
        return !this.isLocal && /^(get|post|head|put|delete|options)$/i.test(this.type) && Yt() || Jt()
    } : Yt;
    var Xt = 0,
        Qt = {},
                ...
                return {
                    send: function(n, i) {
                        ...
                        t = function(n, r) {
                            ...
                            if (u) {
                                i(o, l, u, a.getAllResponseHeaders())
                            }
                        };
                        if (!e.async) {
                            t()
    ...
    d.ajaxTransport("script", function(e) {
        if (e.crossDomain) {
            var t, n = T.head || d("head")[0] || T.documentElement;
            return {
                send: function(i, r) {
    ...
    d.ajaxSetup({
        ...
        jsonpCallback: function() {
            var e = Zt.pop() || d.expando + "_" + xt++;
            this[e] = true;
            return e
        }
    });
    d.ajaxPrefilter("json jsonp", function(t, n, i) {
        var r, a, s, o = t.jsonp !== false && (en.test(t.url) ? "url" : typeof t.data === "string" && !(t.contentType || "").indexOf("application/x-www-form-urlencoded") && en.test(t.data) && "data");
        if (o || t.dataTypes[0] === "jsonp") {
            r = t.jsonpCallback = d.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback;
            if (o) {
                t[o] = t[o].replace(en, "$1" + r)
    ...
    d.offset = {
        setOffset: function(e, t, n) {
            var i, r, a, s, o, l, u, f = d.css(e, "position"),
                c = d(e),
                h = {};
            if (f === "static") {
            ...
            a = d.css(e, "top");
            l = d.css(e, "left");
            u = (f === "absolute" || f === "fixed") && d.inArray("auto", [a, l]) > -1;
            if (u) {
                i = c.position();
                s = i.top;
                r = i.left
    ...
    d.fn.extend({
        offset: function(e) {
            ...
            if (typeof r.getBoundingClientRect !== H) {
    ...
    d.each({
        ...
        d.fn[e] = function(i) {
            return G(this, function(e, i, r) {
                ...
                if (a) {
                    a.scrollTo(!n ? r : d(a).scrollLeft(), n ? r : d(a).scrollTop())
                } else {
                    e[i] = r
                }
    ...
    d.each(["top", "left"], function(e, t) {
        d.cssHooks[t] = Re(f.pixelPosition, function(e, n) {
            if (n) {
                n = _e(e, t);
                return Oe.test(n) ? d(e).position()[t] + "px" : n
            }
        })
    });
    d.each({
...
(function(e) {
    ...
    if (typeof e.uievents === "undefined") {
        e.uievents = {
            scroll: {},
            resize: {}
        }
    ...
    e.fn.on = function() {
        ...
        var r = i[0];
        var a = i[1];
        if (r === "scroll" || r === "resize") {
            var s = "";
            if (this.is(e(window))) {
                s = "window"
            } else if (this.is(e(document))) {
                s = "document"
            } else {
                s = this.selector
            }
            if (typeof e.uievents[r][s] === "undefined") {
                e.uievents[r][s] = []
            }
            var o = e.uievents[r][s];
            if (o.length === 0) {
                o.push(a);
                var l = null;
                var u = n.time ? n.time : 50;
                var f = function() {
                    if (l === null) {
                        l = setTimeout(function() {
                            ...
                            if (n.eventBus !== null) {
                                e(n.eventBus).trigger(r + ".finished")
                            }
                            l = null
                        }, u)
                    }
                };
                return t.apply(this, [r, f])
            } else {
                o.push(a);
                return this
            }
...
var autoSuggestHoverQuickOrder = false;
var autoSuggestPreviousTerm = "";
var autoSuggestURL = "";
var autoSelectOption = -1;
var autoSelectOptionQO = -1;
var historyIndex = -1;
var retrievedCachedSuggestions = false;
var mouseOverSuggestLink = false;
var TOTAL_SUGGESTED = 4;
var TOTAL_HISTORY = 2;
var AUTOSUGGEST_THRESHOLD = 1;
var DYNAMIC_AUTOSUGGEST_THRESHOLD = 1;
var DYNAMIC_AUTOSUGGEST_THRESHOLD_QO = 3;
var CACHED_AUTOSUGGEST_OFFSET = 1e3;
var $window = $(window);

function scrollToTop() {
    $("#backToTopContainer:visible").fadeOut(200);
    $("html, body").animate({
        scrollTop: "0px"
    }, 500)
}
...
function updateBackToTop() {
    var e = $("#backToTopContainer");
    var t = $(".sidebarContent");
    var n = $("#content");
    if (e.length > 0) {
        var i, r, a, s, o;
        if (typeof MoreJS !== "undefined") {
            var l = ($(document).width() - e.outerWidth()) / 2;
            i = l;
            a = "32";
            s = 0;
            o = $window.height() * 2
            ...
            if (window.matchMedia("(max-width: 766px)").matches) {
                ...
                if (($window.width() - n.width()) / 2 > e.width() + 50) {
                    r = ($window.width() - n.width()) / 2 - 50 - e.width()
                } else {
                    r = 60 + ($window.width() - n.width()) / 2
                }
                i = t.offset().left + 50;
                a = 50;
                s = $("#catalogEntryGrid").offset().top + 3 * $(".productBoxContainer").height() - catalog.$window.height();
                o = $("#catalogEntryGrid").offset().top + 2 * $(".productBoxContainer").height()
            }
        }
        if ($window.scrollTop() > s || window.matchMedia("(max-width: 766px)").matches && e.offset().top >= getTop()) {
            if (typeof MoreJS !== "undefined") {
                e.attr("style", "visibility: visible; opacity: 1.0; bottom: " + a + "px; left: " + i + "px !important;")
            } else {
                e.css({
                    visibility: "visible",
                    opacity: "1.0",
...
function clearTextfield(e) {
    if (!e.data("wasSelected")) e.val("");
    if (e.hasClass("search_input")) $(".search_input").data("wasSelected", true);
    else e.data("wasSelected", true)
}

function openModal(e) {
    $("#popupContainer").foundation("reveal", "open", {
        url: e
    })
}

function popupMessage(e, t, n) {
    if (typeof n != "undefined" && n == "class") {
        var i = $("." + e)
    } else {
        var i = $("#" + e)
    }
...
var checkDevice = function() {
    var e = function() {
        var e = "MSIE 8.0";
        var t = ["MSIE 9.0", "MSIE 10.0", "MSIE 11"];
        var n = ["Android", "webOS", "iPhone", "iPad", "iPod", "BlackBerry", "IEMobile", "Opera Mini", "Kindle", "Silk", "MeeGo", "Bada", "Mobile"];
        var i = function() {
            var e = "";
...
function trim(e) {
    ...
    var t = 0;
    var n = word.length - 1;
    while (word.charAt(t) == " ") t++;
    while (word.charAt(n) == " ") n = n - 1;
    if (t > n) {
        return word.substring(t, t)
    } else {
        return word.substring(t, n + 1)
    }
}
...
function ajaxMiniCartRefresh() {
    $(kmo_wcs_pb$.eventBus).one("minicart.refresh", function(e, t) {
        $("#miniShopCart").html(t);
        var n = $(".topBarCartContent.searchCartContent .miniCartContainer");
        if (n.length) {
            $.post("/AjaxShopCartView?storeId=" + kmo_wcs_pb$.getStoreId() + "&langId=" + kmo_wcs_pb$.getLangId() + "&catalogId=" + kmo_wcs_pb$.getCatalogId() + "&isMobileDevice=true", function(e) {
                $(".topBarCartContent.searchCartContent .miniCartContainer").html(e)
            })
        }
    });
    $.post("/AjaxShopCartView?storeId=" + kmo_wcs_pb$.getStoreId() + "&langId=" + kmo_wcs_pb$.getLangId() + "&catalogId=" + kmo_wcs_pb$.getCatalogId(), function(e) {
        $(kmo_wcs_pb$.eventBus).trigger("minicart.refresh", e)
    })
}
...
function highLightSelection(e, t) {
    ...
    if (n != null && n != "undefined") {
        if (e) {
            n.className = "autoSuggestSelected";
            var i = document.getElementById("desktopSearchTerm");
            i.setAttribute("aria-activedescendant", "suggestionItem_" + t);
            var r = document.getElementById("dynamicAutoSuggestTotalResults");
            if (r != null && r != "undefined" && t < r.value || t >= historyIndex) {
                i.value = n.title;
                autoSuggestPreviousTerm = n.title;
                autoSuggestURL = ""
            } else {
                autoSuggestURL = n.href
            }
        } else {
            n.className = ""
        }
...
function enableAutoSelect(e) {
    highLightSelection(false, autoSelectOption);
    var t = document.getElementById("autoSelectOption_" + e);
    t.className = "autoSuggestSelected";
    autoSelectOption = e
}
...
function resetAutoSuggestKeyword() {
    ...
    if (e != null && e != "undefined") {
        var t = document.getElementById("desktopSearchTerm");
        t.value = e.value;
        autoSuggestPreviousTerm = e.value
    }
}

function clearAutoSuggestResults() {
    for (var e = 0; e < staticContent.length; e++) {
        document.getElementById(staticContentSectionDiv[e]).innerHTML = ""
    }
...
function doAutoSuggest(e, t, n) {
    $(".search_input").each(function(e, t) {
        if ($(t).val() != n) {
            $(t).val(n)
        }
    });
    n = $.trim(n);
    if (n.length <= AUTOSUGGEST_THRESHOLD) {
        showAutoSuggest(false);
        return
    }
    if (e.keyCode == 13) {
        e.preventDefault();
        hrefAttr = $("#autoSelectOption_" + autoSelectOption).attr("href");
        if (hrefAttr == "#" || hrefAttr == "" || hrefAttr == undefined) {
            searchTitle = $("#autoSelectOption_" + autoSelectOption).attr("title");
            if (searchTitle != null && searchTitle != undefined && searchTitle.length > 0) {
                $(".search_input").val(searchTitle)
            }
            $("#headerSearchForm").submit()
        } else {
            searchTitle = "";
            if (hrefAttr.indexOf("manufacturer") !== -1) {
                startIndex = hrefAttr.indexOf("=") + 1;
                stopIndex = hrefAttr.indexOf("&");
                searchTitle = hrefAttr.substring(startIndex, stopIndex);
                $(".search_input").val(searchTitle);
                searchTitle = "&searchTerm=" + searchTitle
            }
            $("#autoSelectOption_" + autoSelectOption).mouseover();
            $("#autoSelectOption_" + autoSelectOption).mouseout();
            document.location.href = hrefAttr + searchTitle
        }
        return
    }
    if (e.keyCode == 9) {
    ...
    if (e.keyCode == 38) {
        ...
        if (highLightSelection(true, autoSelectOption - 1)) {
            ...
            autoSelectOption--
        } else if (autoSelectOption == CACHED_AUTOSUGGEST_OFFSET && i != null && i != "undefined") {
            highLightSelection(false, CACHED_AUTOSUGGEST_OFFSET);
            autoSelectOption = i.value - 1;
            highLightSelection(true, autoSelectOption)
        } else {
            highLightSelection(false, autoSelectOption);
            autoSelectOption = -1;
            var r = document.getElementById("autoSuggestOriginalTerm");
            resetAutoSuggestKeyword()
        }
        return
    }
    ...
    if (n.length > AUTOSUGGEST_THRESHOLD && n == autoSuggestPreviousTerm) {
        return
    } else {
        autoSuggestPreviousTerm = n
    }
    ...
    if (n != "") {
        autoSelectOption = -1;
        var a = doStaticAutoSuggest(n);
        if (n.length > DYNAMIC_AUTOSUGGEST_THRESHOLD) {
            var s = true;
            var o = e.target ? e.target : e.srcElement;
            doDynamicAutoSuggest(t, n, s, o)
        } else {
            $(".search_popup").html("");
            showAutoSuggest(false)
        }
...
function doStaticAutoSuggest(e) {
    var t = ["", "", "", "", "", ""];
    var n = 0;
    var i = e.toLowerCase();
    var r = CACHED_AUTOSUGGEST_OFFSET;
    for (var a = 0; a < staticContent.length; a++) {
        var s = 0;
        for (var o = 0; o < staticContent[a].length; o++) {
            var l = staticContent[a][o][0];
            var u = staticContent[a][o][1];
            var f = staticContent[a][o][2];
            var c = l.toLowerCase().indexOf(i);
            if (c != -1) {
                var d = c + f.length - l.length;
                t[a] = t[a] + "<li id='suggestionItem_" + r + "' role='listitem' tabindex='-1'><a id='autoSelectOption_" + r + "' title='" + f + "' onmouseout='this.className=\"\"; autoSuggestURL=\"\";' onmouseover='enableAutoSelect(" + r + "); autoSuggestURL=this.href;' href=\"" + u + '">' + f.substr(0, d) + "<strong>" + f.substr(d, e.length) + "</strong>" + f.substr(d + e.length) + "</a></li>";
                s++;
                r++;
                if (s >= TOTAL_SUGGESTED) {
                    break
                }
            }
        }
    ...
    for (var a = 0; a < staticContent.length; a++) {
        document.getElementById(staticContentSectionDiv[a]).innerHTML = "";
        if (t[a] != "") {
            document.getElementById(staticContentSectionDiv[n]).innerHTML = "<div class='results'><div class='heading'>" + staticContentHeaders[a] + "</div><ul>" + t[a] + "</ul></div>";
            n++
        }
    }
    var h = "";
    ...
    var g = new Array;
    historyIndex = r;
    var m = docCookies.getItem("searchTermHistory");
    if (typeof m != "undefined" && m !== null) {
        ...
        for (var a = v.length - 1; a > 0; a--) {
            ...
            if (b.match("^" + i) == i) {
                ...
                if (!w) {
                    h = h + "<li id='suggestionItem_" + r + "' role='listitem' tabindex='-1'><a href='#' onmouseout='this.className=\"\"' onmouseover='enableAutoSelect(" + r + ");' onclick='selectAutoSuggest(this.title); return false;' title=\"" + y + "\" id='autoSelectOption_" + r + "'><strong>" + e + "</strong>" + y.substring(e.length, y.length) + "</a></li>";
                    g.push(b);
                    s++;
                    r++;
                    if (s >= TOTAL_HISTORY) {
    ...
    if (h != "") {
        p.html("<div class='results'><div class='heading'>" + staticContentHeaderHistory + "</div><ul>" + h + "</ul></div>");
        n++
    }
    if (n > 0) {
...
function changeCheckoutLogonOption(e) {
    $("input[name='logonOption']").prop("checked", false);
    $("#" + e).prop("checked", true);
    if (typeof MoreJS != "undefined" && window.matchMedia("(min-width: " + (kmo_wcs_pb$.getBreakpoint() - 1) + "px)").matches) {
        setTimeout(function() {
            $(".continueButtonLogon").offset({
                top: $(".userLoginButton").offset().top
            })
        }, 700)
    }
}

function checkoutLogon() {
    var e = $("input[name='logonOption']:checked").prop("id");
    if (e === "logonmail" || e === "AccountNumber") {
        $("#LogonForm").submit()
    } else {
        $("#checkoutLogonForm").submit()
    }
}

function infoIconToggle(e) {
    $element = $(e);
    if ($element.parent().hasClass("infoIconHover")) {
        $element.parent().hide()
    } else {
        $element.siblings(".infoIconHover").show()
    }
}

function dropOnSearchField(e) {
    if (e.dataTransfer) {
        var t = "Text";
        var n = e.dataTransfer.getData(t);
        document.getElementById("desktopSearchTerm").value = n
    }
    if (e.stopPropagation) {
        e.stopPropagation()
    } else {
...
function formChanges(e) {
    ...
    if (!e || !e.nodeName || e.nodeName.toLowerCase() != "form") return null;
    var t = [],
        n, i, r, a, s, o;
    for (var l = 0, u = e.elements.length; l < u; l++) {
        n = e.elements[l];
        i = false;
        switch (n.nodeName.toLowerCase()) {
            case "select":
                r = 0;
                for (a = 0, s = n.options.length; a < s; a++) {
                    o = n.options[a];
                    i = i || o.selected != o.defaultSelected;
                    if (o.defaultSelected) r = a
                }
                if (i && !n.multiple) i = r != n.selectedIndex;
                break;
            case "textarea":
            case "input":
                switch (n.type.toLowerCase()) {
                    ...
                    case "checkbox":
                    case "radio":
                        if (n.id != "confirmStradaOpt" && n.id != "confirmShipStradaOpt") {
                            i = n.checked != n.defaultChecked
                        }
                        break;
                    default:
                        i = n.value != n.defaultValue;
                        break
                }
                break
        }
...
var wishlistOption = {
    popup: true,
    addAllToCartFromWishlist: function(e) {
        wishlistOption.popup = false;
        wishlistOption.triggerArray = [];
        var t = true;
        var n = false;
        var i = true;
        var r = 0;
        $(".shoppingCartProductRow").each(function(a, s) {
            if ($("#availability_" + (a + 1)).data("availability") != "undefined" && $("#availability_" + (a + 1)).data("availability") > 2) {
                t = false;
                if (i) {
                    r = a
                }
                wishlistOption.triggerArray.push(function() {
                    if (r = a) {
                        $("#addAllToCartModal").foundation("reveal", "toggle_bg");
                        if (typeof e != "undefined" && e != "") {
                            $(".reveal-modal-bg").css({
                                background: "rgba(0,0,0,0.45) url('" + kmo_wcs_pb$.getImgDir() + "ajax-loader.gif') no-repeat center"
                            })
                        }
                    }
                    $("#addToCartButton_" + (a + 1)).trigger("click");
                    $("#mobileMiniCartAmount").html(parseInt($("#mobileMiniCartAmount").html(), 10) + 1);
                    $("#miniCartAmount").html(parseInt($("#miniCartAmount").html(), 10) + 1)
                });
                i = false
            } else {
                n = true
        ...
        wishlistOption.triggerIndex = 0;
        wishlistOption.triggerArray.push(function() {
            if (typeof MoreJS != "undefined" && window.matchMedia("(max-width: 766px)").matches) {
                $("#addAllToCartModal").foundation("reveal", "toggle_bg");
                $(".miniCartAddAll").addClass("hover");
                setTimeout(function() {
                    $(".miniCartAddAll").removeClass("hover")
                }, 9e3)
            } else {
                if (typeof e == "undefined" || e == "") {
                    $("#addAllToCartModal").foundation("reveal", "open")
                }
                if (typeof MoreJS != "undefined") {
                    setTimeout(function() {
                ...
                if (t) {
                    wishlistOption.showErrorNoneAvailable()
                }
            }
            wishlistOption.popup = true;
            ajaxMiniCartRefresh();
            if (typeof e != "undefined" && e != "") {
                window.location = e
            }
        });
        wishlistOption.triggerArray[0]()
    },
    showErrorNoneAvailable: function() {
        if ($("#requisitionErrorMessages").length) {
            $("#requisitionErrorMessages").children(".noneAvailable").show();
            $window.scrollTop($("#requisitionErrorMessages").offset().top - 20)
        }
    },
    startLoadingLayer: function() {
        $("#addAllToCartModal").foundation("reveal", "toggle_bg");
        $(".reveal-modal-bg").css({
            background: "rgba(0,0,0,0.45) url('" + kmo_wcs_pb$.getImgDir() + "ajax-loader.gif') no-repeat center"
        })
    },
    addAllToCartFromWishlistImproved: function(e, t, n, i) {
        var r = $(".shoppingCartProductRow");
        var a = "";
        r.find("form").each(function(e, t) {
            var r = $(t).serializeArray();
            var s = "";
            var o = true;
            if ($("#inCart_" + (e + 1)).length > 0 && $("#inCart_" + (e + 1)).val() == "true") {
                o = false
            }
            if (typeof n != undefined && n == "CustomLayout" && i) {
                if ($("#availability_" + (e + 1)).data("availability") != "undefined" && $("#availability_" + (e + 1)).data("availability") <= 2) {
                    o = false
                }
            }
            if (o == true) {
                $.each(r, function(t, n) {
                    if (n["name"] != "storeId" && n["name"] != "catalogId" && n["name"] != "langId" && n["name"] != "fromPage") {
                        if (s != "") {
                            s = s + "&" + n["name"] + "_" + (e + 1) + "=" + n["value"]
                        } else {
                            s = n["name"] + "_" + (e + 1) + "=" + n["value"]
                        }
                    }
                });
                if (a != "") {
...
function ajaxAddToCart(e, t) {
    e += e.indexOf("?") > 0 ? "&" : "?";
    e += $(t).serialize();
    var n;
    var i = false;
    if ($("#popupContainer").hasClass("open")) {
        $("#quickViewLoadingIndicator").show();
        n = function(e, t) {
            $("#popupContainer").html(t);
            if (typeof initializePrudsysReco === "function") {
                initializePrudsysReco()
            }
            $("#quickViewLoadingIndicator").hide()
        }
    } else {
        if ($(document).find("#addToBasketLayer").length > 0 && window.innerWidth < 1024) {
            showAddToBasketLayer();
            n = function(e, t) {
                $("#popupContainer").html(t);
                if (typeof initializePrudsysReco === "function") {
                    initializePrudsysReco()
            ...
            if (typeof wishlistOption.popup == "boolean" && wishlistOption.popup == true) {
                if (!(typeof MoreJS != "undefined" && window.matchMedia("(max-width: 766px)").matches)) {
                    i = true
                } else {
                    n = function(e, t) {
                        var n = $(t).find(".errorModalTitle");
                        var i = 3500;
                        if (n.length) {
                            $(".miniCartAddContent").find("span").html(n.html());
                            i = 8e3
                        }
                        MoreJS.refreshAddToCart(i)
                    }
                }
            } else {
                n = function(e, t) {
                    wishlistOption.triggerIndex = wishlistOption.triggerIndex + 1;
                    if (wishlistOption.triggerArray.length >= wishlistOption.triggerIndex) {
    ...
    if (n) {
        $(kmo_wcs_pb$.eventBus).one("product.added", n)
    }
    var r = function(e) {
        $(kmo_wcs_pb$.eventBus).trigger("product.added", e)
    };
    if (i) {
        $("#popupContainer").foundation("reveal", "open", {
            url: e,
...
function ajaxAddToWishlist(e, t) {
    var n = $(t);
    var i = n.find("input[name*='catEntryId']").val();
    var r = n.find("input[name*='field2']").val();
    var a = n.find("input[name*='offerPrice']").val();
    var s = n.find("input[name*='available']").val();
    var o = n.find("input[name*='selectedColor']").val();
    var l = n.find("input[name*='selectedSize']").val();
    var u = n.find("input[name*='productPartNumber']").val();
    e += "&catEntryId=" + i + "&field3=" + r + "&availability=" + s + "&offerprice=" + a + "&selColor=" + o + "&selSize=" + l + "&productPartNumber=" + u;
    if ($("#popupContainer").hasClass("open")) {
        $("#quickViewLoadingIndicator").show();
        $.post(e, function(e) {
            $("#popupContainer").html(e);
            $("#quickViewLoadingIndicator").hide()
        })
    } else {
        if (typeof wishlistOption.popup == "boolean" && wishlistOption.popup == true) {
            if (typeof MoreJS != "undefined" && window.matchMedia("(max-width: 766px)").matches) {
                $.post(e, function(e) {
                    $(kmo_wcs_pb$.eventBus).trigger("wishlistcart.refresh")
                })
            } else {
                $("#popupContainer").foundation("reveal", "open", {
                    url: e
...
function ajaxAddToCartWithRedirectOnClose(e, t, n) {
    $("#popupContainer").on("close.fndtn.reveal", function() {
...
function addToCartFromWishlist(e, t) {
    if (!($("#availability_" + e).hasClass("availability-2") || $("#availability_" + e).hasClass("availability-1"))) {
        ajaxAddToCart(t + "&currentPage=wishlist", $("#AddToCartForm_" + e));
        return true
    }
    if ($("#requisitionErrorMessages").length) {
        $("#requisitionErrorMessages").children(".notAvailable").show();
        $window.scrollTop($("#requisitionErrorMessages").offset().top - 20)
    }
    return false
}

function submitOnReurnKey(e, t) {
    if (t.keyCode == 13) {
        e.form.submit()
    }
}

function isValidDate(e, t, n) {
    var i = true;
    if (t < 1 || t > 12) i = false;
    else if (e < 1 || e > 31) i = false;
    else if ((t == 4 || t == 6 || t == 9 || t == 11) && e > 30) i = false;
    else if (t == 2 && isLeapYear(n) && e > 29) i = false;
    else if (t == 2 && !isLeapYear(n) && e > 28) i = false;
    return i
}
...
function isDateInTheFuture(e, t, n) {
    var i = n + "/" + t + "/" + e;
    i = new Date(Date.parse(i.replace(/-/g, " ")));
    today = new Date;
...
function validateDateAndClearFields(e, t, n) {
    var i = e.val();
    var r = t.val();
    var a = n.val();
    var s = isValidDigit(i) && isValidDigit(r) && isValidDigit(a);
    if (i == "" && r == "" && a == "") {
        e.removeClass("error");
        t.removeClass("error");
        n.removeClass("error");
...
function validateAccount(e, t) {
    var n = e.val();
    var i = t.val();
    if (n == "" && i == "") {
        return true
    } else if (isValidDigit(n) && n.length == "7" && (isValidDigit(i) && i.length == "2")) {
        e.removeClass("error");
        t.removeClass("error");
        return true
    } else {
...
function isValidDigit(e) {
    return Math.floor(e) == e && $.isNumeric(e)
}

function isFullAge(e, t, n, i) {
    if (n == "") return true;
    var r = new Date;
    r.setFullYear(n, t - 1, e);
    var a = new Date;
    a.setFullYear(a.getFullYear() - i);
    var s = new Date;
    return a - r < 0 || s.getFullYear() - n > 112 ? false : true
}

function closeModalAndRefreshSite() {
    $("#reveal-modal").trigger("reveal:close");
    location.reload()
}

function removeSEOLinks(e) {
    $(e).each(function() {
        $link = $(this);
        linkContent = $link.html();
        $linkParent = $link.parent();
        $link.remove();
        $linkParent.append(linkContent)
    })
}

function saveSeoText(e, t) {
    $.post(e, $(t).serialize(), function(e) {
        closeModalAndRefreshSite()
    })
}

function deleteSeoText(e) {
    $.post(e, function(e) {
        location.reload()
    })
}

function seoSetHrefAttribute(e) {
    if (e.hasAttribute("data-reveal-href")) {
        e.setAttribute("href", e.getAttribute("data-reveal-href"))
    } else {
        if (window.console && window.console.log) console.log("Call js function seoSetHrefAttribute() without html-field data-reveal-href.")
    }
}
...
function getURLParam(e) {
    ...
    var t = "[\\?&]" + e + "=([^&#]*)";
    var n = new RegExp(t);
    var i = n.exec(window.location.href);
    if (i == null) return null;
    else return i[1]
}

function changeSelectedProductAttributeQO(e, t, n) {
    $("#qoAttrDiv_" + e).find(".selected").removeClass("selected");
    $("#" + n.replace(/\//g, "\\/") + "_" + e).toggleClass("selected", true)
}

function toggleFAQCategory(e) {
    var t = $(e);
    if (t.hasClass("faqHeader")) {
        if (t.hasClass("opened")) {
            return
        }
        var n = $(".faqHeader, .faqBodyContainer");
        n.removeClass("opened");
        n.children(".faqAnswer, .faqQuestionContainer").removeClass("opened");
        setTimeout(function() {
            if (!isVisible(t)) {
                $("html, body").animate({
                    scrollTop: t.offset().top - 128
                }, 750)
            }
        }, 500)
    }
...
function ajaxSizeCalculator() {
    $("#sizeCalcLoadingIndicator").show();
    $.post($("#calcForm").attr("action") + "?" + $("#calcForm").formSerialize(), function(e) {
        try {
            var t = JSON.parse(e);
            ajaxSizeCalculatorJSON(t)
        } catch (n) {
            ajaxSizeCalculatorHTML(e)
        }
        $("#sizeCalcLoadingIndicator").hide()
    });
    return false
}

function ajaxSizeCalculatorJSON(e) {
    var t = "calcCupSize,calcDressSize,calcFootSize,calcShirtSize,calcSizeTable,calcTrousersSize".split(",");
    for (var n = 0; n < t.length; n++) {
        var i;
        if (e[t[n]] == "not.found") {
            i = labels.noSizeMatch
        } else {
            i = e[t[n]]
        }
        $("#" + t[n]).html(i)
...
function ajaxSizeCalculatorHTML(e) {
    $(".sizeCalculatorResult").html($(e).html())
}
Number.prototype.toMoney = function(e, t) {
    if (typeof e === "undefined") var e = "1.00 $";
    var n = e.indexOf(",") != -1 ? "," : ".";
    var i = this,
        r = e.indexOf("0") === -1 ? 0 : 1 + e.lastIndexOf("0") - e.indexOf("0"),
        a = n === "," ? "." : ",",
        s = i < 0 ? "-" : "",
        o = parseInt(i = Math.abs(i).toFixed(r)) + "",
        l = (l = o.length) > 3 ? l % 3 : 0,
        u = e.charAt(0) === "1" ? e.charAt(e.length - 1) : e.charAt(0);
    symbolAtEnd = e.indexOf(u) === 0 ? false : true;
    var f = s + (l ? o.substr(0, l) + a : "") + o.substr(l).replace(/(\d{3})(?=\d)/g, "$1" + a) + (r ? n + Math.abs(i - o).toFixed(r).slice(2) : "");
    if (symbolAtEnd) return f + " " + t;
    else return t + " " + f
};

function scdContinueButton() {
    $(".bottom > .continueButton > a").trigger("click")
}

function getUrlParameter(e) {
    siteUrl = window.location.search.substring(1);
    siteParams = siteUrl.split("&");
    for (var t = 0; t < siteParams.length; t++) {
        var n = siteParams[t].split("=");
        if (n[0] == e) {
            return n[1]
        }
    }
...
function stripProtocol(e) {
    return e.replace(/.*?:/g, "")
}

function sendFormOverHttps(e) {
    e.action = e.action.replace(/^http:/, "https:");
    return true
}
...
function ajaxPromotionCodeAddRemove(e, t) {
    if (loaded) return;
    var n = $("#" + e).serialize();
    loaded = true;
    $.post($("#" + e).attr("action"), n, function(e) {
        $("#" + t).html(e)
    }).done(function() {
        loaded = false
    });
...
function isAndroid() {
    ...
    var t = e.toLowerCase().indexOf("android") > -1;
    return t
}

function isiOS() {
    var e = navigator.userAgent;
    var t = e.match(/iPhone/i) || e.match(/iPod/i) || e.match(/iPad/i) != null;
    return t
}

function isWindowsPhone() {
    var e = navigator.userAgent;
    var t = e.toLowerCase().indexOf("iemobile") > -1;
    return t
}
...
function getTop() {
    ...
    var t = $(".productBoxContainer3");
    var n = t.length > 0;
    if (n) {
        if (e && n > 1) {
            if (t.get(1).length > 0) {
                return $(t.get(1)).offset().top
            }
        } else {
            return $(t.get(0)).offset().top
        }
    } else {
        return Number.POSITIVE_INFINITY
    }
}
var touchEvents = function(e, t) {
    var n = null;
    var i = null;
    var r = function(e) {
    ...
    var a = function(e) {
        ...
        var r = e.originalEvent.changedTouches[0].clientX;
        ...
        if (Math.abs(s) > Math.abs(o)) {
            ...
            if (o > 0) {
                if (typeof t.up != "undefined") {
                    t.up()
                }
            } else if (o < 0) {
                if (typeof t.down != "undefined") {
                    t.down()
                }
            }
        }
...
function showLoadIndicator(e) {
    var t = $("#loadingIndicator");
    if (e !== undefined) {
        t.addClass(e)
    }
    t.show();
    updateCatLoadIndicatorPosition()
}

function hideLoadIndicator(e) {
    var t = $("#loadingIndicator");
    t.hide();
    if (e !== undefined && t.hasClass(e)) {
        t.removeClass(e)
    }
}

function updateCatLoadIndicatorPosition() {
    var e = $(".catalogLoadingIndicator");
    if (e.is(":visible")) {
        var t = e.find("img");
        var n = t.outerWidth();
        t.css({
            left: ($("#content").width() - n) / 2
        })
    }
}

function showAddToBasketLayer() {
    if ($("#addToBasketLayerText").html() == "") $("#addToBasketLayerText").append(labels.addToBasketLayerMsg);
    $("#addToBasketLayer").fadeIn(1e3);
    setTimeout("$('#addToBasketLayer').fadeOut( 1000 );", 6e3)
}
...
function getDistance(e, t, n) {
    var i = $(e),
        r = $(t);
    if (n === "y") {
        return r.offset().top - i.height() - i.offset().top
    } else {
        return r.offset().left - i.width() - i.offset().left
    }
}

function markActiveSecondLayerCategory() {
    if (typeof kmo_wcs_pb$.getCategoryNavLayout === "function" && kmo_wcs_pb$.getCategoryNavLayout() === "TwoLayer") {
        var e;
        if ($(".selected.gotChild.availableSubcategories>a").length > 0) {
            e = $(".selected.gotChild.availableSubcategories").attr("data-categoryid")
        } else if ($(".breadcrumbsEntry.last").length) {
            e = $(".breadcrumbsEntry.last").attr("data-categoryid")
        }
        $(".secondLayerCategoryNavList").find("li").each(function() {
            if ($(this).attr("data-categoryId") === e) {
...
function scrollIntoViewOnSubhome(e, t) {
    if ($(window).width() > 849) {
        document.getElementById(t).scrollIntoView()
    } else {
        t = "#" + t;
        letterId = t.split("_")[1];
        var n = 120;
        if ($(window).width() < 470) {
            n = 75
        }
        if ($("#" + letterId).hasClass("lastActive")) {
            e.scrollTop(e.scrollTop() + $(t).offset().top + n)
        } else {
            e.scrollTop(e.scrollTop() + $(t).position().top - n)
        }
    }
}
$(document).safeReady(function() {
    computeScrollableBrandContainerHeight();
    if ($(document).find("#brandOverview").length > 0) {
        $("#brandOverview").find(".active").each(function() {
            $("#" + $(this).parent().attr("id").split("_")[1]).addClass("opened")
        });
        $(window).on("resize", function() {
            if ($(window).width() < 470) {
                var e = $(".brandSubhomeContainer").find(".next").width() + $(".brandSubhomeContainer").find(".prev").width();
                var t = $("#brandCarousel").width() / 4;
                $("#brandCarousel").find("li").each(function() {
                    $(this).css("width", t + "px")
                })
            }
        })
...
function computeScrollableBrandContainerHeight() {
    if ($(window).width() < 850) {
        $("#brandOverview").css("max-height", $(window).height() - 250 + "px")
    }
}
var langId = kmo_wcs_pb$.getLangId();
if (langId == "22" || langId == "41") $("body").addClass("frShop");
if (langId == "42") $("body").addClass("nlShop");
if (checkDevice.isIE()) {
    $("body").addClass("is-ie")
}(function(e) {
    if (typeof define === "function" && define.amd) {
    ...
    e.extend(e.fn, {
        ...
        rules: function(t, n) {
            var i = this[0],
                r, a, s, o, l, u;
            if (t) {
                r = e.data(i.form, "validator").settings;
                a = r.rules;
                ...
                switch (t) {
                    case "add":
                        ...
                        a[i.name] = s;
                        if (n.messages) {
                            r.messages[i.name] = e.extend(r.messages[i.name], n.messages)
                        }
                        break;
                    case "remove":
                        if (!n) {
                        ...
                        e.each(n.split(/\s/), function(t, n) {
                            ...
                            delete s[n];
                            if (n === "required") {
                                e(i).removeAttr("aria-required")
                            }
                        });
                        return u
                }
            }
            o = e.validator.normalizeRules(e.extend({}, e.validator.classRules(i), e.validator.attributeRules(i), e.validator.dataRules(i), e.validator.staticRules(i)), i);
            if (o.required) {
                l = o.required;
                delete o.required;
                o = e.extend({
    ...
    e.extend(e.validator, {
        ...
        prototype: {
            ...
            elementValue: function(t) {
                ...
                if (r === "radio" || r === "checkbox") {
                    ...
                    return t.validity.badInput ? false : i.val()
                }
                n = i.val();
                if (typeof n === "string") {
            ...
            check: function(t) {
                ...
                for (o in n) {
                    ...
                    try {
                        s = e.validator.methods[o].call(this, a, t, l.parameters);
                        if (s === "dependency-mismatch" && i === 1) {
                            r = true;
                            continue
                        }
                        r = false;
                        ...
                        if (!s) {
                            this.formatAndAdd(t, l);
                            return false
                        }
                    } catch (u) {
                        if (this.settings.debug && window.console) {
                            console.log("Exception occurred when checking element " + t.id + ", check the '" + l.method + "' method.", u)
                        }
                        throw u
                    }
                }
            ...
            showLabel: function(t, n) {
                ...
                if (s.length) {
                    ...
                    s = e("<" + this.settings.errorElement + ">").attr("id", o + "-error").addClass(this.settings.errorClass).html(n || "");
                    i = s;
                    if (this.settings.wrapper) {
                    ...
                    if (s.is("label")) {
                        s.attr("for", o)
                    } else if (s.parents("label[for='" + o + "']").length === 0) {
                        a = s.attr("id");
                        if (!l) {
                            l = a
                        } else if (!l.match(new RegExp("\b" + a + "\b"))) {
                            l += " " + a
                        }
                        ...
                        if (r) {
                            e.each(this.groups, function(t, n) {
                                if (n === r) {
                                    e("[name='" + t + "']", this.currentForm).attr("aria-describedby", s.attr("id"))
                                }
                            })
                        }
                    }
        ...
        attributeRules: function(t) {
            ...
            for (a in e.validator.methods) {
                ...
                if (/min|max/.test(a) && (r === null || /number|range|text/.test(r))) {
                    s = Number(s)
                }
                if (s || s === 0) {
                    n[a] = s
        ...
        normalizeRules: function(t, n) {
            e.each(t, function(i, r) {
                ...
                if (r.param || r.depends) {
                    ...
                    if (a) {
                        t[i] = r.param !== undefined ? r.param : true
                    } else {
                        delete t[i]
                    }
                }
                ...
                e.ajax(e.extend(true, {
                    ...
                    success: function(i) {
                        ...
                        if (s) {
                            ...
                            o[n.name] = r.message = e.isFunction(l) ? l(t) : l;
...
(function(e) {
    ...
    e.validator.passwordRating = function(u, f) {
        e(".checkoutPage #password").keyup(function() {
            var t = e(".password-meter").find(".password-meter-message");
            if (!this.value) {
                if (t != undefined) {
                    t.hide()
                }
        ...
        if (!u || u.length < 5) return o(0, "too-short");
        if (!u || u.length > 15) return o(0, "too-long");
        if (f && u.toLowerCase().match(f.toLowerCase())) return o(2, "similar-to-username");
        if (s.test(u)) return o(2, "very-weak");
        if (a.test(u)) return o(0, "not-alphanum");
        var c = t.test(u),
            d = n.test(l(u)),
            h = i.test(u),
            p = r.test(u),
            g = a.test(u);
        if (c && d && h && u.length > 11) return o(4, "strong");
        if ((c && d || c && h || d && h) && u.length >= 8) return o(3, "good");
        return o(3, "weak")
    };
    e.validator.passwordRating.messages = {
        "similar-to-username": validateLabels.pwdTooSimilar,
        "too-short": validateLabels.pwdTooShort,
        "too-long": validateLabels.pwdTooLong,
        "not-alphanum": validateLabels.pwdAlphanumeric,
        "very-weak": validateLabels.pwdVeryWeak,
        weak: validateLabels.pwdWeak,
        good: validateLabels.pwdGood,
        strong: validateLabels.pwdStrong
    };
    e.validator.addMethod("password", function(t, n, i) {
        var r = n.value,
            a = e(typeof i != "boolean" ? i : []);
        var s = e.validator.passwordRating(r, a.val());
        var o = e(".password-meter", n.form);
        o.find(".password-meter-bar").removeClass().addClass("password-meter-bar").addClass("password-meter-" + s.messageKey);
        o.find(".password-meter-message").removeClass().addClass("password-meter-message").addClass("password-meter-message-" + s.messageKey).text(e.validator.passwordRating.messages[s.messageKey]);
        return s.rate >= 2
    }, "&nbsp;");
    e.validator.classRuleSettings.password = {
        password: true
    }
})(jQuery);
(function(e) {
    ...
    function i(t, n) {
        ...
        a.intervalId = 0;
        a.cachedResponse = {};
        a.onChangeInterval = null;
        a.onChange = null;
        a.isLocal = false;
        a.suggestionsContainer = null;
        a.options = e.extend({}, s, n);
        a.classes = {
    ...
    i.prototype = {
        ...
        initialize: function() {
            ...
            t.suggestionsContainer = i.utils.createNode(a.containerClass);
            s = e(t.suggestionsContainer);
            s.appendTo(a.appendTo);
            if (a.width !== "auto") {
                s.width(a.width)
            }
            ...
            s.on("mouseout.autocomplete", function() {
                t.selectedIndex = -1;
                s.children("." + r).removeClass(r)
            });
            s.on("click.autocomplete", n, function() {
                t.select(e(this).data("index"))
            });
            t.fixPosition();
            ...
            e(window).on("resize.autocomplete", t.fixPositionCapture);
        ...
        setOptions: function(t) {
            ...
            if (n.isLocal) {
                i.lookup = n.verifySuggestionsFormat(i.lookup)
            }
        ...
        fixPosition: function() {
            ...
            if (t.options.width === "auto") {
                i.width = t.el.outerWidth() - 2 + "px"
            }
            e(t.suggestionsContainer).css(i)
        },
        ...
        isCursorAtEnd: function() {
            ...
            if (document.selection) {
                ...
                return t === i.text.length
            }
            return true
        },
        onKeyPress: function(e) {
            var t = this;
            if (!t.disabled && !t.visible && e.which === n.DOWN && t.currentValue) {
                t.suggest();
                return
            }
            ...
            switch (e.which) {
                ...
                case n.RETURN:
                    ...
                    if (e.which === n.TAB && t.options.tabDisabled === false) {
                        return
                    }
                    break;
                case n.UP:
        ...
        onValueChange: function() {
            ...
            t.currentValue = i;
            t.selectedIndex = -1;
            if (n.triggerSelectOnValidInput) {
                a = t.findSuggestionIndex(r);
                if (a !== -1) {
                    t.select(a);
                    return
                }
        ...
        getSuggestionsLocal: function(t) {
            ...
            if (s && o.suggestions.length > s) {
                o.suggestions = o.suggestions.slice(0, s)
            }
            return o
        },
        getSuggestions: function(t) {
            ...
            if (i.isLocal) {
                n = i.getSuggestionsLocal(t)
            } else {
                if (e.isFunction(a)) {
                    a = a.call(i.element, t)
                }
                o = a + "?" + e.param(s || {});
                n = i.cachedResponse[o]
            }
            if (n && e.isArray(n.suggestions)) {
                i.suggestions = n.suggestions;
                i.suggest()
            } else if (!i.isBadQuery(t)) {
                if (r.onSearchStart.call(i.element, r.params) === false) {
                    return
                }
                if (i.currentRequest) {
                    i.currentRequest.abort()
                }
                i.currentRequest = e.ajax({
                    url: a,
                    data: s,
                    type: r.type,
                    dataType: r.dataType
                    ...
                    n = r.transformResult(e);
                    i.processResponse(n, t, o);
                    r.onSearchComplete.call(i.element, t, n.suggestions)
                }).fail(function(e, n, a) {
                    r.onSearchError.call(i.element, t, e, n, a)
                })
            }
        },
        ...
        suggest: function() {
            ...
            e.each(t.suggestions, function(e, t) {
                u += '<div class="' + a + '" data-index="' + e + '">' + i(t, r) + "</div>"
            });
            if (n.width === "auto") {
                c = t.el.outerWidth() - 2;
                o.width(c > 0 ? c : 300)
        ...
        findBestHint: function() {
            ...
            e.each(t.suggestions, function(e, t) {
                var r = t.value.toLowerCase().indexOf(n) === 0;
                if (r) {
                    i = t
                }
                return !r
        ...
        signalHint: function(t) {
            var n = "",
                i = this;
            if (t) {
                n = i.currentValue + t.value.substr(i.currentValue.length)
            }
            if (i.hintValue !== n) {
                i.hintValue = n;
                i.hint = t;
        ...
        processResponse: function(e, t, n) {
            ...
            if (!r.noCache) {
                ...
                if (r.preventBadQueries && e.suggestions.length === 0) {
                    i.badQueries.push(t)
                }
            }
            if (t !== i.getQuery(i.currentValue)) {
                return
            }
        ...
        activate: function(t) {
            var n = this,
                i, r = n.classes.selected,
                a = e(n.suggestionsContainer),
                s = a.children();
            a.children("." + r).removeClass(r);
            n.selectedIndex = t;
            if (n.selectedIndex !== -1 && s.length > n.selectedIndex) {
                i = s.get(n.selectedIndex);
                e(i).addClass(r);
                return i
            }
            return null
        ...
        adjustScroll: function(t) {
            ...
            r = i.offsetTop;
            a = e(n.suggestionsContainer).scrollTop();
            s = a + n.options.maxHeight - o;
            if (r < a) {
                e(n.suggestionsContainer).scrollTop(r)
            } else if (r > s) {
                e(n.suggestionsContainer).scrollTop(r - n.options.maxHeight + o)
            }
        ...
        getValue: function(e) {
            ...
            return i.substr(0, i.length - r[r.length - 1].length) + e
        },
        dispose: function() {
            var t = this;
