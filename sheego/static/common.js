...
catalogi.parse = function() {
    ...
    $( "#header-topbar > div > div" ).append( "<div id='topbar-slogan' class='col-md-4 hidden-xs hidden-sm'><a href='http://www.catalogi.ru' target='_blank' class='headerLinks _home catalogiLink'> Каталоги.ру <span class='hidden-xs hidden-sm'>- заказ и доставка одежды из интернет-магазина Sheego.de.</span></a></div>"
                                            + "<div class=' col-md-6'>"
                                            ...
                                            + "<a href='#' id='delivery' class='headerLinks notranslate hidden-xs hidden-sm' onclick='catalogi.delivery(); return false' style='margin-left:0px; margin-right:0px;'> Дocтавка </a>|"
                                            ...
                                            + "<a href='#' id='delivery' class='headerLinks notranslate hidden-xs hidden-sm' onclick='catalogi.delivery(); return false' style='margin-left:0px; margin-right:0px;'> Дocтавка </a></div>");
