...
catalogi.parse = function() {
    ...
    $( "#header-topbar > div > div" ).append( "<div class='col-md-12'><div id='topbar-slogan' class='col-md-4'><a href='http://www.catalogi.ru' target='_blank' class='headerLinks _home catalogiLink'> Каталоги.ру <span class='hidden-xs hidden-sm'>- заказ и доставка одежды из интернет-магазина Sheego.de.</span></a></div>"
                                            + "<div class=' col-md-6'>"
